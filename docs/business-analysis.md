...
1. [Business Understanding](#1-business-understanding)
   ...
   - 1.5 [Competitive Matrix](#15-competitive-matrix)
   - 1.6 [Porter's Five Forces](#16-porters-five-forces)
   - 1.7 [Gap Analysis](#17-gap-analysis)
2. [Customer Understanding](#2-customer-understanding)
   - 2.1 [Personas](#21-personas)
3. [Pending Analyses](#3-pending-analyses)
   - 3.1 [SWOT](#31-swot)
   - 3.2 [Risk Matrix](#32-risk-matrix)
   - 3.3 [Value Proposition Canvas](#33-value-proposition-canvas)
   - 3.4 [Revenue and Cost Structure](#34-revenue-and-cost-structure)
   - 3.5 [User Journeys](#35-user-journeys)
4. [Appendix: Sources](#4-appendix-sources)
...
- More than 207 million creators are active worldwide (some sources say 400 million or more if occasional creators are counted, while Goldman Sachs estimates 50 million as "professionalized").
- In the US, full time creators grew from 200 thousand in 2020 to 1.5 million in 2024. Creators now account for 30% of the growth of the US digital economy.
- Influencer marketing alone reached US$32.55B in 2025, up 35.6% from 2024, and is projected to reach US$40.51B in 2026.
- Income is very unequal. Half of creators earn less than US$15,000 a year, and only about 4% earn more than US$100,000 a year.
- Brand deals make up about 70% of creator income.
- YouTube alone supported more than 425,000 full time jobs in the US and added US$25B to US GDP in 2021, according to Oxford Economics.
- Brands already put between 20% and 40% of their digital marketing budgets into creator partnerships.

The rise of creators is changing traditional media too. Ad budgets are moving from TV and traditional media to creators, since niche content now competes directly with mass programming. Brands prefer creators because audiences trust them more than traditional ads (58% of US consumers say they bought something because an influencer recommended it). Traditional journalism and entertainment have started copying creator strategies, using subscriptions and branded content of their own.
...
Engagement data by follower range, Instagram, 2026:
...
Nano creators get about 219% more engagement than mega influencers, and this pattern shows up in every reliable dataset studied, including Influencer Marketing Hub, HypeAuditor, Social Cat, and ViralMango. They are also cheaper per engagement: a nano or micro creator costs between US$0.18 and US$0.20 per meaningful interaction, versus 65% more at the macro level.
...
2. Then came the fraud problem. Research found that a large share of engagement on sponsored posts was fake. In one analysis, 25% of the followers of 10,000 influencers were fake, and half of the engagement on sponsored content was likely fraudulent. This wasted billions in ad budget and pushed brands like Unilever, L'Oréal, and Samsung to demand more transparency.
...
5. By 2026, eMarketer expects micro and nano influencers to take 45.5% of all influencer marketing spend, a real structural move of budget.

In Brazil the shift is even stronger. Nielsen counted more than 500,000 content creators in the country in 2022. Squid's own 2023 census found that about 40% of Brazilian influencers have fewer than 10,000 followers, and 78% have up to 50,000. In other words, the Brazilian market was already built around micro and nano creators. That same data showed nano creators with an average engagement rate of 8.7%, against only 1.5% for macro influencers in traditional campaigns, an even bigger gap than the global average. Brazil today has more than 500,000 content creators and 12 million nano influencers online. As of 2026, 30% of Brazilians discover new products through creators every day, and 80% of consumers trust influencer recommendations.
...
*Every number, percentage, market value, and date used in this section came from an external source. The full list is in [Appendix: Sources, A.1](#4-appendix-sources).*
...
This leads to the core question behind Aurora: what can Aurora do that Creator Ads cannot do without hurting its own business? Only about 2% of Brazil's R$80 billion media budget currently goes to creators, which means the ceiling is not the real constraint. The constraint is that nobody has built real infrastructure for the middle of the market, and nobody treats creators as customers worth keeping rather than as interchangeable supply.

*The market figures cited here, including the 2% and R$80 billion numbers, are sourced in [Appendix: Sources, A.2](#4-appendix-sources).*
...
Founded in 2014 by Felipe Oliva and Carlos Tristan. One of Brazil's pioneers in influencer marketing, built as a data driven platform that connects creators to agencies and companies, automating identification, recruitment, management, and payment.

![Squid](./images/business-analysis/squid2.png)

Ownership has changed hands more than once. Locaweb bought 100% of Squid for about R$176.5M in 2021. It was rebranded Wake Creators in 2023, then bought by the UNLK fund in October 2025, and reverted to the Squid name in November 2025. In June 2026 it launched Squid OS, its AI powered flagship product, aimed at a "perfect match" between brands and influencers.

Its business model runs on a take rate for transactions between creators and brands, closer to a marketplace than to a software subscription. ARR passed R$100M around the time of the Locaweb acquisition. It also runs a performance product, Squid Performance, billed on CPC, CPL, CPI, and CPA, including hybrid models where top performing influencers earn an extra sales commission. Squid OS claims to go one step further than matching: it says its AI delivers a ready media strategy decision to the client, and automates briefing delivery, compliance, and creator payment. It is modular, so brands can use only the pieces they need. No public evidence was found of automated mid campaign budget reallocation, so the claims center on matching and decision support rather than fully autonomous optimization.
...
CreatorIQ is included here because it marks the ceiling Aurora would eventually compete against if it ever moves upmarket or goes international. It runs on enterprise SaaS pricing with annual, per seat contracts. Entry pricing is reported around $35,000 to $36,000 a year, with enterprise tiers reaching six figures, and realistic budgets often land between $200,000 and $800,000 a year depending on team size. This is a fundamentally different model from the Brazilian players, since it charges for seats and governance tools, not for media spend or transaction volume.

Its strength is in decision support and governance rather than autonomous media buying: discovery, measurement, attribution, and compliance workflows. Its Creator Graph processes more than 123 million social posts a day across more than 15 million creators, using direct API data instead of scraped numbers. Its brand safety product, SafeIQ, launched in October 2025 and claims to be the first brand specific, self learning safety tool in the industry, learning each brand's own risk thresholds instead of applying one fixed score to everyone. CreatorIQ works with more than 1,300 brands and agencies, including Disney, Unilever, Dell, Google, LVMH, Nestlé, Sephora, and Delta Air Lines, and Forrester rates it highest for measurement, data science, and influencer data management.
...
BR Media is included because it represents the largest deal in the Brazilian market so far, and it shows where the category is heading structurally. Publicis Groupe acquired it in 2024 for about R$550M, taking on an ecosystem of more than 500,000 creators and 500 brands.

Its relevance to Aurora is less about product features and more about what the deal signals. First, holding companies are now buying into this space directly, which means agency groups are becoming owners of creator infrastructure rather than staying on the sidelines. This matters for the still open question of how agencies fit into Aurora's model: they may be buyers of infrastructure, not just parties being replaced. Second, deal volume in the sector grew 72% in 2025, a sign of ongoing consolidation. Combined with Squid changing owners twice and Creator Ads expanding internationally, the market is settling around a small number of well funded platforms.
...
PlayNest, created by Play9 (a media company founded by João Pedro Paes Leme, Felipe Neto, and Marcus Vinícius Freire), focuses on professionalizing digital influencers through educational content and an automated media kit. It runs two products: PlayNest Creators, for growing and monetizing on social media, and PlayNest Business, where brands connect with creators through expert curation. It has more than 50,000 registered creators.
...
*Every figure, date, and claim about each company in this section is sourced in [Appendix: Sources, A.2](#4-appendix-sources).*
...
*The comparison data in this matrix is sourced in [Appendix: Sources, A.2 and A.3](#4-appendix-sources).*
...
Creator Ads raised a R$35M seed from Kaszek, has 500k creators, works with 10 of Brazil's 20 largest advertisers, holds 97% retention, grew 500% in six months, hired a former Publicis CEO as president, and is expanding to the US and Mexico. Squid has 11 years in the market, 300k+ creators, and clients like Ambev, Unilever, and Natura, and just relaunched as Squid OS in June 2026. Sandwiche raised R$3.5M, works with 75+ brands including Mastercard and GM, and already operates in Spain and Germany. Deal volume across the sector grew 72% in 2025.
...
A few questions remain open, and are addressed again in the Gap Analysis below. Why exactly did the mid-market stay empty? It could be CAC economics that do not work out, ticket sizes too small to cover operating costs, small and medium brands lacking a recurring media budget, or simply Locaweb failing to execute well. The first three of those would hit Aurora too. Do nano creators actually choose which jobs they accept, or do they take everything offered to them? If they take everything, the supply side advantage disappears. And is actively recruiting creators even affordable at scale?
...
*This section reuses company and market data already sourced in [Appendix: Sources, A.2 and A.3](#4-appendix-sources).*
...
| Agencies are becoming builders and buyers of infrastructure, not being cut out | Publicis bought BR Media for about R$550M, MField is building its own tool called Atlas, and sector deal volume grew 72% in 2025 | Agencies as a distribution channel and as an infrastructure customer, bringing their own creators and running their clients' campaigns on Aurora |
| The category is validated and still underused | 10 of the 20 largest advertisers already buy this way with 97% retention, yet only about 2% of R$80bn in media spend goes to creators | No need to educate the market from scratch, since someone else already paid that cost |
...
#### What Aurora dropped, and why it matters to record this

| Original pillar | Why it was dropped |
|---|---|
| Programmatic buying of creator pools | Creator Ads launched this in November 2024, and Squid adopted the same framing by June 2026. It became table stakes |
| Real time optimization | Creator Ads already redistributes budget automatically, with L'Oréal as the reference case |
| Message level brand safety | Already covered twice over, by GuardIAn in Brazil and SafeIQ globally |
| A curated network as a hard to copy advantage | Every base is non exclusive, and the same creator sits on every platform. Curation over a shared pool of creators is not a real moat |

#### Three questions that still decide everything

1. Why did the mid-market stay empty? It could be that CAC does not work out, that ticket size does not cover operating costs, that small and medium brands have no recurring media budget, or that Locaweb simply failed to execute. The first three of those would affect Aurora too.
2. Does a nano creator actually get to choose which job to accept? If creators are sitting idle and accepting everything offered to them, the idea of treating creators as customers loses its whole advantage.
3. Is actively recruiting creators actually affordable? Finding and converting creators outside of self registration has a real cost. If that cost is too high, the plan does not work financially.

The resulting thesis, in one sentence:

> Aurora is creator media infrastructure for the mid-market, with an advantage built on the supply side: it actively recruits nano and micro creators outside the self registration model and treats them as customers, becoming the platform they prefer to work with.

*The evidence cited in the tables above draws on the sources already listed in [Appendix: Sources, A.2 and A.3](#4-appendix-sources).*
...
<!-- Add the Aurora branded version generated in Claude Design here. See the prompt for this template at the end of this document, in Appendix A.5. -->
...
**Persona 3: Agency (role still undecided)**

The agency's role in the product has not been decided yet. There are three open hypotheses for how it might fit.

Hypothesis A, agency as a customer: the agency uses the tool to run nano and micro campaigns on behalf of its own clients, treating Aurora as infrastructure, similar to how a company might use AWS.

Hypothesis B, agency as a curation partner: agencies bring human judgment on things AI does not do well, like fitting a creator's voice to a brand, and the tool pays or integrates them as a service layer.

Hypothesis C, agency gets cut out: the product replaces most of what the agency does today, like curation, negotiation, and management. In this case, the agency is less of a customer persona and more of an indirect competitor, or an early distribution channel at best.

A common concern among agencies today, if this becomes a customer persona: the real difference between a mediatech and a traditional agency is how much weight goes to human judgment versus an algorithm in curation. Agencies worry about losing that edge if everything becomes self service. Which hypothesis, A, B, or C, fits best for the Agency persona is still an open decision.

---

## 3. Pending Analyses

The frameworks below have not been built yet. Each one keeps its Overview filled in, explaining the tool and how it connects to what has already been documented above, while Detailed Analysis and Conclusions stay open until the underlying research gets done.

### 3.1 SWOT

#### Overview

SWOT stands for Strengths, Weaknesses, Opportunities, and Threats. It is a planning framework that maps a company's internal capabilities against outside market conditions in a simple 2x2 grid. It complements Porter's Five Forces, covered in section 1.6, which looks at how attractive the industry is as a whole, by asking a more specific question: given how this industry is shaped, what does Aurora actually bring to the table, and what is working against it. The Gap Analysis in section 1.7 and the Five Forces analysis already give a lot of the raw material this SWOT will draw on. For example, the open mid-market segment and the idea of treating creators as customers point naturally toward Opportunities and Strengths, while dependency on platforms like Meta and TikTok, and the disproven idea of a curated network as an advantage, point toward Threats and Weaknesses.

#### Aurora Application

![swot](./images/swot-aurora.png)
<!-- Add the Aurora branded version generated in Claude Design here. -->
...
A risk matrix scores identified risks along two axes, likelihood and impact, to help decide which threats need an active mitigation plan and which ones just need to be watched. For Aurora, the three open questions raised in the Gap Analysis, why the mid-market is empty, whether nano creators actually choose their jobs, and whether actively recruiting creators is affordable, are a natural starting list for this matrix, along with the structural risks already raised in Porter's Five Forces, like dependency on platforms and a high threat of substitutes.

#### Aurora Application

![risk_matrix](./images/risk-matrix-aurora.png)
<!-- Add the Aurora branded version generated in Claude Design here. -->
...
The Value Proposition Canvas maps a customer profile, meaning their jobs to be done, pains, and gains, against a value map, meaning pain relievers, gain creators, and the actual product or service, to test whether an offer truly fits what a customer needs. It builds directly on the Marina and Duda personas documented in section 2.1. The frustrations and needs already gathered for each persona map almost directly onto the Pains and Gains parts of the canvas.

#### Aurora Application

![value_proposition_canvas](./images/value-proposition-canvas-aurora.png)
<!-- Add the Aurora branded version generated in Claude Design here. -->
...
### 3.4 Revenue and Cost Structure

#### Overview

Revenue Streams and Cost Structure are two of the nine building blocks in the Business Model Canvas, describing how the business earns money and what it costs to run. The pricing comparison already gathered in the Competitive Matrix, section 1.5, covering take rate, media spend, SaaS seats, and affiliate commission, is the direct input for deciding Aurora's own revenue model. The supply side thesis from the Gap Analysis, actively recruiting creators, also implies a cost line that competitors relying on self registration simply do not have: the cost of acquiring each creator.

#### Aurora Application

![revenue_cost_structure](./images/revenue-cost-structure-aurora.png)
<!-- Add the Aurora branded version generated in Claude Design here. -->
...
User journeys are step by step maps of how each persona moves through the product, showing where friction happens and which moments matter most. With three personas defined in section 2.1, Brand, Creator, and Agency, and the Agency persona still undecided among three hypotheses, the user journeys cannot be finished until that question is resolved. The Brand and Creator journeys, however, can already start from the goals and frustrations captured in that section.

#### Aurora Application

![user_journeys](./images/user-journeys-aurora.png)
<!-- Add the Aurora branded version generated in Claude Design here. -->
...
A note before the list: the original research behind this document was gathered from public sources, press coverage, company materials, and analyst reports. In most cases the source was recorded as a publication or institute name, not as a link to one specific article. Where a real, stable link exists, meaning an official company or product website, it is included below. For press outlets and research firms, only the name is listed, since inventing a specific article URL would risk pointing to the wrong page or to a page that does not exist. If an exact citation is needed for any of these, the original article should be looked up directly on the outlet's site.

### A.1 Industry Context and Analysis (section 1.1)

Market size and creator economy figures:
- Research and Markets, Coherent Market Insights, Precedence Research, Grand View Research, and [Market.us](https://market.us/), covering 2026 creator economy market size reports
- Goldman Sachs Research, covering creator economy growth projections
- Oxford Economics and Washington Post Creative Group, covering YouTube's economic impact on the US
- IAB, the Interactive Advertising Bureau, covering digital employment data
- Springboard, Shopify, Axiacore, and Medium (Flybridge), covering history and origin of the term "creator"
- EMARKETER, covering 2026 influencer marketing spend data

Nano and micro shift data:
- TANKE, AutoFaceless Blog, Marketing Inc, [eciks.org](https://eciks.org/), Jem Social, [Promote.sh](https://promote.sh/), Markhub24, and Glomm, covering engagement and ROI data by follower tier, 2026
- SoftwareSuggest, StackInfluence, MikMak, Marketing Insider Group, Tomoson, Business of Fashion, Forbes, Phyllo, and Curemedia, covering history of the shift toward nano and micro creators, and influencer fraud data
- Meio & Mensagem (covering Wake), LinkedIn and Squid company posts, Fast Company Brasil, SEGS, Squid's own Brazil Content Creator Census, Consumidor Moderno, Gazz Conecta, and Propmark, covering Brazilian market data

### A.2 Market Players (section 1.4) and The Problem (section 1.2)

Company and product websites, used for direct company facts:
- Creator Ads: [www.creatorads.io](https://www.creatorads.io/) and [brandlovrs.com](https://brandlovrs.com)
- Squid: [squid.com.br](https://squid.com.br/)
- PlayNest: [playnest.com.br](https://www.playnest.com.br/) and [business.playnest.com.br](https://business.playnest.com.br/)
- Sandwiche: [sandwiche.me](https://sandwiche.me/)
- CreatorIQ: [creatoriq.com](https://www.creatoriq.com/)
- BR Media Group: [br-mediagroup.com](https://br-mediagroup.com/)

Press and analyst coverage:
- Exame, Meio & Mensagem, Startups.com.br, Propmark, ABC da Comunicação, Mundo do Marketing, StartSe, and Gazz Conecta, covering primary reporting on Creator Ads, Squid, Sandwiche, and sector M&A
- GKPB, Olhar Digital, and Startupi, covering the Locaweb and Squid acquisition
- Mercado&Consumo, covering the Squid and Wake Creators rebrand
- Terra, Adnews, and CB Insights, covering BrandLovers and Creator Ads
- Interney, Rock Content, B2B Stack, Lado M, oHub, and 140 Online, covering mapping of smaller Brazilian players
- Kantar Ibope Media, Statista, HypeAuditor with ESPM's State of Influencer Marketing report, CreatorIQ's own State of Safety report, Forrester, and G2, covering analyst and market data
- Interney's market mapping, April 2026

The 2% of Brazil's roughly R$80 billion media budget going to creators, cited in both section 1.2 and section 1.4, traces back to this same press and analyst coverage, primarily Exame and the Kantar Ibope Media and Statista market data listed above.

### A.3 Competitive Matrix (section 1.5)

- Exame, covering Squid OS and BrandLovers' Guardian AI tool
- Shopify Brasil, Agência e-Plus, Remessa Online, Gazz Conecta, and ABC da Comunicação, covering Squid features, payment flow, and Squid Performance pricing
- PlayNest Business official site, and Marcas Mais, covering PlayNest pricing and features
- Terra, NeoFeed, Startups.com.br, and public App Store listings, covering Creator Pay, Creator Ads internationalization, and creator reviews
